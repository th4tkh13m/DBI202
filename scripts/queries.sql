...
SELECT TOP 1 WITH TIES roomCode, semester, waterAmount, elecAmount, MAX(incurredCost)
FROM INCURRED 
GROUP BY roomCode, semester, waterAmount, elecAmount
ORDER BY MAX(incurredCost) DESC

-- 7. khu vực 1 có bao nhiêu phòng, thông tin yêu cầu mã phòng
